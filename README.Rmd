...
[![Travis-CI Build Status](https://travis-ci.org/alex23lemm/farsR.svg?branch=master)](https://travis-ci.org/ManuelAlejandroMartinezFlores/farsR)
...
devtools::install_github("ManuelAlejandroMartinezFlores/farsR")
```
